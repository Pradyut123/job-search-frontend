              ...
              <div className="mt-6">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <button
                    ...
                    className="border-[2px] rounded-[10px] block p-[10px]  text-[14px] font-semibold text-textColor bg-yellow-500 hover:bg-blue-500 group-hover/item:text-textColor group-hover:text-white"
                  >
                    Apply Today
